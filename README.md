...
- Во время обработки бот обновляет отдельное статус-сообщение с прогрессом: скачивание (в процентах для ссылок) и сжатие (в процентах по времени кодирования).
